...
export const tsportCategoricalGroups = new Set(["10", "11", "16", "75", "68", "81", "82", "98",
 ...
 */
export function decodeTsportCategoricalTerms(group: string, line: string | null, live: boolean): Terms | null {
