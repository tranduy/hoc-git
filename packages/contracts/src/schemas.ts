...
export const MarketTypeSchema = z.enum([
  ...
  "HOME_FT_GOAL_RANGE", "AWAY_FT_GOAL_RANGE", "HOME_FH_GOAL_RANGE", "AWAY_FH_GOAL_RANGE",
  "CORNER_FT_RANGE", "CORNER_FH_RANGE", "HOME_CORNER_FT_RANGE", "AWAY_CORNER_FT_RANGE",
  "FT_HALF_FULL_RESULT", "FT_RESULT_BTTS", "FH_RESULT_BTTS", "FT_DOUBLE_CHANCE_BTTS", "FT_RESULT_TOTAL",
  ...
  "YELLOW_CARD_FT_1X2", "YELLOW_CARD_FT_DOUBLE_CHANCE", "FT_DRAW_NO_BET", "FH_DRAW_NO_BET", "SH_DRAW_NO_BET",
  "FT_1X2",
  "FT_AH",
  "FT_TOTAL",
  "FH_1X2",
  ...
  "HOME_FT_ODD_EVEN",
  "AWAY_FT_ODD_EVEN",
  "HOME_FH_ODD_EVEN", "AWAY_FH_ODD_EVEN", "HOME_SH_ODD_EVEN", "AWAY_SH_ODD_EVEN",
  "HOME_FT_WIN_TO_NIL",
  "AWAY_FT_WIN_TO_NIL",
  "HOME_FT_CLEAN_SHEET",
  "AWAY_FT_CLEAN_SHEET",
...
export const ProviderTicketPreflightSchema = z.strictObject({
  ...
  reasons: z.array(z.enum(["IDENTITY_MISMATCH", "ODDS_CHANGED", "MARKET_NOT_OPEN",
    ...
    "FINANCIAL_POLICY_UNAVAILABLE"])).max(9)
...
export const TicketRealtimeDisplayedLegSchema = z.strictObject({
  ...
  selection: z.string().trim().min(1).max(128),
  line: DecimalStringSchema.nullable(),
  providerParticipantA: z.string().trim().min(1).max(256).optional(),
  providerParticipantB: z.string().trim().min(1).max(256).optional(),
  providerSelection: z.string().trim().min(1).max(128).optional(),
  providerLine: DecimalStringSchema.nullable().optional(),
  rawOdds: DecimalStringSchema,
  rawFormat: OddsFormatSchema,
  decimalOdds: NonnegativeDecimalStringSchema,
  quoteStatus: QuoteStatusSchema,
